...
입력하거나, 체크를 해제해 일반 수정으로 실행할 수도 있습니다. 파일 전체 링크가 아니라
...
페이지 모드는 현재 뷰포트 기준이며, 캡처 영역과 Figma 크기가 다르면 임의로 늘이거나 줄이지 않습니다.
...
중단합니다. 목표 미달은 `unmatched`, 접근·캡처 실패는 `blocked`로 남고 통과로 표시하지 않습니다.
